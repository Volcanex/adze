...
.page { max-width: 414px; margin: 0 auto; position: relative; padding-top: 140px; padding-bottom: 120px; min-height: 100vh; display: flex; flex-direction: column; }
...
@media (min-width: 768px) {
    .page { max-width: 1000px; padding-top: 190px; padding-bottom: 160px; }
...
<div class="page">
    ...
    <nav id="site-menu" class="menu-overlay" aria-hidden="true">
        ...
        <a class="m-about is-current" href="/about/">About</a>
