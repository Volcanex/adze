...
<div class="page">
    ...
    <img class="exh-image" src="../../assets/good_grief1.jpeg" alt="GOOD GRIEF">

    <div class="title-row">
        <h1 class="exh-title">GOOD GRIEF</h1>
        <div class="exh-meta">
            <span>2022</span><span>group show</span><span>London, UK</span>
        </div>
    </div>

    <div class="exh-desc">
        Group exhibition staged in a temporary space in East London. Work focused on small-scale paintings exploring loss, memory and the consolations of the everyday.
    </div>

    <dl class="detail-list">
        <dt>Year</dt><dd>2022</dd>
        <dt>Type</dt><dd>group show</dd>
        <dt>Venue</dt><dd>London, UK</dd>
    </dl>
