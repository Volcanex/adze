...
<div class="page">
    ...
    <nav id="site-menu" class="menu-overlay" aria-hidden="true">
        ...
        <a class="m-exhibitions is-current" href="/exhibitions/">Exhibitions</a>
    ...
    <div class="title-row">
        <h1 class="exh-title">Art on a Postcard</h1>
        <div class="exh-meta">
            <span>2025</span><span>Winter Auction</span><span>London, UK</span>
        </div>
    </div>
    ...
    <dl class="detail-list">
        ...
        <dt>Type</dt><dd>Winter Auction</dd>
