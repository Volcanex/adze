...
<div class="page">
    ...
    <img class="exh-image" src="../../assets/Works_2024_Moonlit_Sea.jpg" alt="">

    <div class="title-row">
        <h1 class="exh-title">Kobokan stories</h1>
        <div class="exh-meta">
            <span>2024</span><span>solo show and workshop</span><span>Tokyo, JPN</span>
        </div>
    </div>

    <div class="exh-desc">
        Solo presentation and accompanying workshop staged in a residency space in Tokyo. New paintings developed over six weeks on site, alongside a public drop-in session for visitors to contribute their own marks to a collective banner.
    </div>

    <dl class="detail-list">
        <dt>Year</dt><dd>2024</dd>
        <dt>Type</dt><dd>solo show and workshop</dd>
        <dt>Venue</dt><dd>Tokyo, JPN</dd>
    </dl>
