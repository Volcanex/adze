...
<div class="page">
    ...
    <img class="exh-image" src="../../assets/Works_2022_Night_fishing.png" alt="">

    <div class="title-row">
        <h1 class="exh-title">Discard Archives</h1>
        <div class="exh-meta">
            <span>2023</span><span>group show</span><span>London, UK</span>
        </div>
    </div>

    <div class="exh-desc">
        A group show built around objects and images salvaged from studio cast-offs. Contribution included three drawings on found paper.
    </div>
