...
<div class="page">
    ...
    <img class="exh-image" src="../../assets/Works_2022_Murmuration.jpg" alt="">

    <div class="title-row">
        <h1 class="exh-title">Axxx/Blood</h1>
        <div class="exh-meta">
    ...
    <div class="exh-desc">
        A two-part group show pairing painting with sculpture. Included two new oil paintings made specifically for the exhibition.
    </div>
