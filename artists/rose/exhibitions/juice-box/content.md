...
<div class="page">
    ...
    <img class="exh-image" src="../../assets/Works_2024_Marsh_at_Sunset.JPG" alt="">

    <div class="title-row">
        <h1 class="exh-title">Juice box</h1>
        <div class="exh-meta">
    ...
    <div class="exh-desc">
        Tightly curated group show of recent graduates and current students. Two paintings included, both from the 2022 'fishing' series.
    </div>
