...
.intro {
    padding: 80px 15px 0;
    font-weight: 400; font-size: 15px; line-height: 17px;
    color: var(--contact);
}
...
.details a { color: var(--contact); text-decoration: none; }
...
<div class="page">
    ...
    <div class="details">
        ...
        <p>Instagram — <a href="https://instagram.com/rosefpjones">@rosefpjones</a></p>
    </div>
