...
<div class="page">
    ...
    <div class="title-row">
        <h1 class="work-title">You belong at the head of the table</h1>
        <div class="work-meta">
    ...
    <div class="work-desc">
        A short, dummy description for <em>You belong at the head of the table</em>. Replace this paragraph with notes on the work — what it explores, the materials, the moment it was made in. The image above is a placeholder; swap it for the real photograph when you have one.
    </div>
