...
<div class="page">
    ...
    <img class="work-image" src="../../assets/Works_2024_Moonlit_Sea.jpg" alt="Moonlit Sea">
    ...
    <div class="work-desc">
        A short, dummy description for <em>Moonlit Sea</em>. Replace this paragraph with notes on the work — what it explores, the materials, the moment it was made in. The image above is a placeholder; swap it for the real photograph when you have one.
    </div>
