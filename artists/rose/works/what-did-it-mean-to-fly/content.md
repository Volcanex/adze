...
<div class="page">
    ...
    <img class="work-image" src="../../assets/Works_2022_Skip_Kids.jpeg" alt="">

    <div class="title-row">
        <h1 class="work-title">What did it mean to fly</h1>
        <div class="work-meta">
            <span>2023</span><span>Oil on linen</span><span>120 × 90 cm</span>
        </div>
    </div>

    <div class="work-desc">
        A short, dummy description for <em>What did it mean to fly</em>. Replace this paragraph with notes on the work — what it explores, the materials, the moment it was made in. The image above is a placeholder; swap it for the real photograph when you have one.
    </div>
