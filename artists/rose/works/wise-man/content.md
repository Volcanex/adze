...
<div class="page">
    ...
    <img class="work-image" src="../../assets/Works_2022_Divine_Like_a_Bird_01.jpeg" alt="">

    <div class="title-row">
        <h1 class="work-title">Wise Man</h1>
        <div class="work-meta">
            <span>2021</span><span>Oil on linen</span><span>120 × 90 cm</span>
        </div>
    </div>

    <div class="work-desc">
        A short, dummy description for <em>Wise Man</em>. Replace this paragraph with notes on the work — what it explores, the materials, the moment it was made in. The image above is a placeholder; swap it for the real photograph when you have one.
    </div>
