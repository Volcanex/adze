...
<div class="page">
    ...
    <figure class="work-figure" style="aspect-ratio:1834/2560">
        <img class="work-image" src="../../assets/work-skip-kids-good.jpg" alt="Skip Kids" decoding="async">
    </figure>
    ...
    <div class="title-row">
        ...
        <div class="work-meta">
            <span>2022</span><span>Oil on canvas</span><span>220 x 190 cm</span>
        </div>
    </div>
    ...
    <dl class="detail-list">
        ...
        <dt>Dimensions</dt><dd>220 x 190 cm</dd>
    </dl>
