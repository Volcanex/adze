...
<div class="page">
    ...
    <figure class="work-figure" style="aspect-ratio:1920/2560">
        <img class="work-image" src="../../assets/work-worship-good.jpg" alt="Worship" decoding="async">
    </figure>

    <div class="title-row">
        <h1 class="work-title">Worship</h1>
        <div class="work-meta">
            <span>2021</span><span>Monoprint</span><span>A4</span>
        </div>
    </div>
    ...
    <dl class="detail-list">
        ...
        <dt>Medium</dt><dd>Monoprint</dd>
        <dt>Dimensions</dt><dd>A4</dd>
    </dl>
