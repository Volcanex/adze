...
<div class="page">
    ...
    <figure class="work-figure" style="aspect-ratio:1920/2560">
        <img class="work-image" src="../../assets/work-while-we-sit-together-good.jpg" alt="While We Sit Together" decoding="async">
    </figure>
    ...
    <div class="title-row">
        ...
        <div class="work-meta">
            <span>2022</span><span>Oil on canvas</span><span>220 x 160 cm</span>
        </div>
    </div>
    ...
    <dl class="detail-list">
        ...
        <dt>Dimensions</dt><dd>220 x 160 cm</dd>
    </dl>
