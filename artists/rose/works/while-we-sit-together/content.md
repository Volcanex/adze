...
<div class="page">
    ...
    <img class="work-image" src="../../assets/Works_2022_My_Memory_of_your_Birth.jpeg" alt="">

    <div class="title-row">
        <h1 class="work-title">While we sit together</h1>
        <div class="work-meta">
    ...
    <div class="work-desc">
        A short, dummy description for <em>While we sit together</em>. Replace this paragraph with notes on the work — what it explores, the materials, the moment it was made in. The image above is a placeholder; swap it for the real photograph when you have one.
    </div>
