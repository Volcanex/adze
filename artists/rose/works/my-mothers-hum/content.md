...
<div class="page">
    ...
    <img class="work-image" src="../../assets/good_grief.jpeg" alt="">

    <div class="title-row">
        <h1 class="work-title">My Mothers Hum</h1>
        <div class="work-meta">
    ...
    <div class="work-desc">
        A short, dummy description for <em>My Mothers Hum</em>. Replace this paragraph with notes on the work — what it explores, the materials, the moment it was made in. The image above is a placeholder; swap it for the real photograph when you have one.
    </div>
