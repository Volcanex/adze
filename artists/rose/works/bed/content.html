...
<div class="page">
    ...
    <figure class="work-figure" style="aspect-ratio:1672/2330">
        <img class="work-image" src="../../assets/work-bed-good.jpg" alt="Bed" decoding="async">
    </figure>


    <div class="title-row">
        <h1 class="work-title">Bed</h1>
        <div class="work-meta">
            <span>2025</span>
        </div>
    </div>
