...
<div class="page">
    ...
    <figure class="work-figure" style="aspect-ratio:2115/2560">
        <img class="work-image" src="../../assets/work-tara-good.jpg" alt="Tara" decoding="async">
    </figure>



    <div class="title-row">
        <h1 class="work-title">Tara</h1>
        <div class="work-meta">
            <span>2025</span><span>Oil on Canvas</span><span>107x127</span>
        </div>
    </div>
    ...
    <dl class="detail-list">
        ...
        <dt>Dimensions</dt><dd>107x127</dd>
    </dl>
