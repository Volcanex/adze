...
<div class="page">
    ...
    <figure class="work-figure" style="aspect-ratio:1861/2560">
        <img class="work-image" src="../../assets/work-untitled-good.jpg" alt="Untitled" decoding="async">
    </figure>

    <div class="title-row">
        <h1 class="work-title">Untitled</h1>
        <div class="work-meta">
            <span>2022</span><span>Charcoal on paper; oil on canvas</span>
        </div>
    </div>
    ...
    <dl class="detail-list">
        ...
        <dt>Medium</dt><dd>Charcoal on paper; oil on canvas</dd>
    </dl>
