...
<div class="page">
    ...
    <div class="work-desc">
        A short, dummy description for <em>Night fishing 2</em>. Replace this paragraph with notes on the work — what it explores, the materials, the moment it was made in. The image above is a placeholder; swap it for the real photograph when you have one.
    </div>
