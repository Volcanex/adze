...
<header class="navbar">
    ...
    <ul class="nav-links">
        <li><a href="../home/">Home</a></li>
            ...
            <li><a href="../opening-hours/" class="active">Opening Hours</a></li>
...
<article class="page">
    <div class="eyebrow">Come in</div>
    <h1>Opening hours.</h1>
    <p class="lede">Four days a week. No late nights &mdash; we'd rather be fresh each morning.</p>
    ...
    <div class="info-card">
        <h3>Annual closure</h3>
        <p>We close between Christmas and New Year each year. Any other changes to our hours go up on the <a href="../updates/">Updates</a> page and in the shop window.</p>
    </div>

    <p>Friday box collections begin at noon &mdash; see the <a href="../order/">Order</a> page.</p>
</article>
