...
<article class="page">
    ...
    <h1>A family shop, on Heaton Road since 1999.</h1>

    <div class="portrait-pair reveal">
        <figure>
            <div class="portrait"><img src="../assets/images/mum_in_the_shop.png" alt="Elaine Penman behind the veg counter" loading="lazy"></div>
            <figcaption><strong>Elaine Penman</strong><span>Founder · Owner</span></figcaption>
        </figure>
        <figure>
            <div class="portrait"><img src="../assets/images/dad_in_the_shop.png" alt="Rob Penman at the fruit and veg display" loading="lazy"></div>
            <figcaption><strong>Rob Penman</strong><span>Owner</span></figcaption>
        </figure>
    </div>

    <p>The shop opened in 1999 with that aim baked in: not-for-profit from day one, sourcing organic and local where possible, paying suppliers fairly, keeping prices honest. Twenty-five years later that hasn't changed &mdash; every pound that comes through the till goes back into the shop.</p>

    <p>Rob first walked in as a customer in the early 2000s. He stayed. He's been part of the business ever since, and today Elaine and Rob run The Honey Tree together, supported by a small staff team who are actively involved in how the shop works &mdash; from the orders that come in to the displays you see when you walk through the door.</p>

    <h2 style="font-family: var(--heading-font); font-style: italic;">What you'll find in store</h2>
    <ul>
        <li>Organic fruit &amp; veg, in fresh weekly from local growers</li>
        <li>Loose wholefoods by weight &mdash; rices, pulses, pastas, flours, nuts, dried fruit</li>
        <li>Refill beauty &amp; cleaning products &mdash; bring your own bottles</li>
        <li>Bread, dairy, and everyday grocery staples</li>
        <li>Ethically sourced tea, coffee, chocolate &amp; pantry goods</li>
        <li>A weekly organic box scheme &mdash; <a href="../order/">order one here</a></li>
    </ul>

    <h2 style="font-family: var(--heading-font); font-style: italic;">The team</h2>
    <p>Profiles for the rest of the staff are coming &mdash; we want to do them properly. In the meantime, if you're a regular you'll know most of them by name already.</p>

    <div class="staff-grid">
        <div class="staff-card placeholder"><div class="ph-portrait"></div><div class="ph-meta"><strong>Coming soon</strong><span>—</span></div></div>
        <div class="staff-card placeholder"><div class="ph-portrait"></div><div class="ph-meta"><strong>Coming soon</strong><span>—</span></div></div>
        <div class="staff-card placeholder"><div class="ph-portrait"></div><div class="ph-meta"><strong>Coming soon</strong><span>—</span></div></div>
        <div class="staff-card placeholder"><div class="ph-portrait"></div><div class="ph-meta"><strong>Coming soon</strong><span>—</span></div></div>
    </div>
    ...
    <div class="info-card">
        <h3>Come in</h3>
        <p>68 Heaton Road, Heaton, Newcastle upon Tyne NE6 5HL<br>
        Open Tue, Wed, Fri, Sat &mdash; <a href="../opening-hours/">see full hours</a>.</p>
    </div>
</article>
