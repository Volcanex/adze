...
<article class="page">
    <div class="eyebrow">News from the shop</div>
    <h1>Updates.</h1>
    <p class="lede">Seasonal notices, changes to our hours, and what's on the veg counter this week.</p>

    <div class="update-item reveal">
        <span class="date">7 December 2024</span>
        <h2>Christmas opening times</h2>
        <p>Our hours over the holidays: <strong>Monday 23rd December</strong> &mdash; open 11am to 6pm. <strong>Tuesday 24th December</strong> &mdash; open 11am to 4pm. We then close from Christmas Day and reopen at normal hours on <strong>Tuesday 7th January</strong>.</p>
    </div>

    <div class="update-item reveal">
        <span class="date">6 December 2024</span>
        <h2>Christmas orders '24</h2>
        <p>Christmas veg boxes are open for order. £20, collected from the shop on the Friday before Christmas. Place orders by our usual Tuesday-noon deadline &mdash; or sooner, as they go fast. Head to the <a href="../order/">order page</a> to book.</p>
    </div>

    <div class="update-item reveal">
        <span class="date">Recently</span>
        <h2>Website back online</h2>
        <p>Our site is up and running again &mdash; thanks for everyone's patience while we sorted it out. If anything looks odd, drop us an email at <a href="mailto:thehoneytreeshopteam@gmail.com">thehoneytreeshopteam@gmail.com</a>.</p>
    </div>
</article>
