...
<article class="page">
    ...
    <h1>Contact.</h1>
    <p class="lede">Email is the quickest way to reach us from outside the shop. We reply promptly during opening hours.</p>
    ...
    <div class="info-card reveal">
        <h3>In person</h3>
        <p>68 Heaton Road<br>
        Heaton, Newcastle upon Tyne<br>
        NE6 5HL</p>
        <p><a href="../opening-hours/">Check our opening hours</a> before you set off.</p>
    </div>

    <h2>Send us a message</h2>
    <p>Questions about an order, a product, or a supplier &mdash; or something you'd like us to stock? Write to us at the email above, or call in to the shop. We read everything.</p>
</article>
