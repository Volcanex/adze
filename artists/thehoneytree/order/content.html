...
<header class="navbar">
    ...
    <ul class="nav-links">
        ...
        <li><a href="../order/" class="order-cta active">Order a Box</a></li>
    </ul>
</header>

<article class="page">
    <div class="eyebrow">Weekly organic boxes</div>
    <h1>Order a box.</h1>
    <p class="lede">£20. Order by Tuesday noon, collected from the shop on Friday from 12pm.</p>

    <div class="notice reveal">
        <strong>How it works:</strong> place your order by <strong>Tuesday noon</strong>. Boxes are ready for collection from <strong>Friday at noon</strong>. Orders made after the Tuesday deadline roll to the following Friday.
    </div>

    <h2>Our boxes</h2>
    <div class="box-grid reveal">
        <div class="box">
            <h3>Organic Veg Box</h3>
            <p class="price">£20</p>
            <small>Seasonal veg — ~6–8 items</small>
        </div>
        <div class="box">
            <h3>Organic Fruit Box</h3>
            <p class="price">£20</p>
            <small>Seasonal fruit — ~5–7 items</small>
        </div>
        <div class="box">
            <h3>Fruit &amp; Veg Box</h3>
            <p class="price">£20</p>
            <small>A mix of both</small>
        </div>
        <div class="box">
            <h3>Xmas Veg Box</h3>
            <p class="price">£20</p>
            <small>December only</small>
        </div>
    </div>

    <p>Box contents change week by week with the season &mdash; pop into the shop or email us if you'd like to know what's likely to be in this week's. We can accommodate most swaps for allergies or strong dislikes.</p>

    <h2>How to order</h2>
    <ol>
        <li>Email <a href="mailto:thehoneytreeshopteam@gmail.com?subject=Box%20order">thehoneytreeshopteam@gmail.com</a> with the box you'd like, your name, and a mobile number.</li>
        <li>Let us know if you'd like to set up a regular weekly subscription.</li>
        <li>Collect from the shop on Friday from noon. We'll hold it until Saturday close.</li>
    </ol>

    <div class="info-card reveal">
        <h3>Regular subscription</h3>
        <p>Prefer not to think about it each week? Tell us when you order and we'll set up a standing box for you &mdash; no commitment, pause any time.</p>
    </div>
</article>
