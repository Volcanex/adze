...
.sc-embed:hover { border-color: var(--blue); }
...
.sc-link:hover { color: var(--blue-deep); }
...
<section class="wrap">
    <div class="eyebrow">SoundCloud</div>
    <h1>Music</h1>

    <div class="sc-embed">
        <iframe width="100%" height="520" scrolling="no" frameborder="no" allow="autoplay" loading="lazy"
            title="Keskesay on SoundCloud"
            src="https://w.soundcloud.com/player/?url=https%3A//soundcloud.com/user-216694930&color=%231a35ff&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=false&visual=true"></iframe>
    </div>

    <a class="sc-link" href="https://soundcloud.com/user-216694930" target="_blank" rel="noopener">Open on SoundCloud &rarr;</a>
</section>
